...
const Skills = () => {
  return (
    <section
      id="skills"
      className="flex flex-col gap-3 h-full relative overflow-hidden mt-56 w-full"
      style={{ transform: "scale(0.9)" }}
    >
      <SkillText />

      <div className=" flex flex-row justify-center lg:justify-start sm:pl-16 flex-wrap mt-4 gap-5 ">
